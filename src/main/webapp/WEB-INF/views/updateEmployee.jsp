...
<div class="w-full flex justify-center">
    <div class="w-1/2 max-w-md mx-auto my-8 p-6 border border-gray-200 rounded-lg shadow-md">
        <h2 class="text-2xl font-bold underline mb-6">Modifier Employé</h2>

        <form action="/updateEmployee" method="post" class="space-y-4">
            ...
            <div>
                <select required name="pole" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-300">
                    ...
                    <option value="researchDevelopment">Recherche et Développement (R&D) / Innovation</option>                </select>
            </div>
